...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                'db_table': 'Department',
                'constraints': [models.UniqueConstraint(fields=('department_name',), name='unique depart')],
            },
        ),
        migrations.CreateModel(
            name='DeviceSetting',
            ...
            options={
                ...
                'constraints': [models.UniqueConstraint(fields=('device_name',), name='unique device')],
            },
        ),
        migrations.CreateModel(
            name='Employees',
            fields=[
                ...
                ('iqama_number', models.CharField(blank=True, max_length=255, null=True)),
                ...
                ('created_date', models.DateTimeField(auto_now=True)),
                ('department', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='department_id', to='attendanceapp.department')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(blank=True, choices=[('Present', 'Present'), ('Absent', 'Absent'), ('Late', 'Late'), ('On Leave', 'OnLeave')], max_length=255, null=True)),
                ('employee_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='employee_idss', to='attendanceapp.employees')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('leave_type', models.CharField(blank=True, choices=[('Sick', 'Sick'), ('Casual', 'Casual'), ('Emergency', 'Emergency'), ('Other', 'Other')], max_length=255, null=True)),
                ...
                ('created_date', models.DateTimeField(auto_now=True)),
                ('employee_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='employee_id_leave', to='attendanceapp.employees')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_date', models.DateTimeField(auto_now=True)),
                ('employee_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='employee_ids', to='attendanceapp.employees')),
            ],
            options={
